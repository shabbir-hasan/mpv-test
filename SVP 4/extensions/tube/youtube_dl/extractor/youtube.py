...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _VALID_URL = r"""(?x)^
                     ...
                     #!SVP #(?!.*?\blist=
                     #!SVP #   (?:
                     #!SVP #       %(playlist_id)s|                                  # combined list/video URLs are handled by the playlist IE
                     #!SVP #       WL                                                # WL are handled by the watch later IE
                     #!SVP #   )
                     #!SVP #)
    ...
    def _get_subtitles(self, video_id, webpage):
        ...
        if not sub_lang_list:
            #!SVP #self._downloader.report_warning('video doesn\'t have subtitles')
            return {}
    ...
    def _get_automatic_captions(self, video_id, webpage):
        ...
        if not player_config:
            #!SVP #self._downloader.report_warning(err_msg)
            return {}
        try:
            ...
            if caption_url:
                ...
                if original_lang_node is None:
                    #!SVP #self._downloader.report_warning('Video doesn\'t have automatic captions')
                    return {}
    ...
    def _real_extract(self, url):
        ...
        if 'conn' in video_info and video_info['conn'][0].startswith('rtmp'):
            ...
            #!SVP #if 'rtmpe%3Dyes' in encoded_url_map:
            #!SVP #    raise ExtractorError('rtmpe downloads are not supported, see https://github.com/rg3/youtube-dl/issues/343 for more information.', expected=True)
            formats_spec = {}
