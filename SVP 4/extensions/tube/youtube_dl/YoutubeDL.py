...
class YoutubeDL(object):
    ...
    #!SVP #
    def find_extractor(self,url):
        for ie in self._ies:
            if ie.suitable(url):
                return [ie.ie_key(),ie.__module__]
        ...
        for ie in ies:
            ...
            try:
                ...
                if self.params.get('ignoreerrors', False):
                    ...
                    raise
        #!SVP #else:
        #!SVP #    self.report_error('no suitable InfoExtractor for URL %s' % url)
    ...
    def process_video_result(self, info_dict, download=True):
        ...
        #!SVP #if self.params.get('listsubtitles', False):
        #!SVP #    if 'automatic_captions' in info_dict:
        #!SVP #        self.list_subtitles(info_dict['id'], info_dict.get('automatic_captions'), 'automatic captions')
        #!SVP #    self.list_subtitles(info_dict['id'], subtitles, 'subtitles')
        #!SVP #    return
        ...
        if self.params.get('listformats'):
            #!SVP #self.list_formats(info_dict)
            return info_dict #!SVP #
